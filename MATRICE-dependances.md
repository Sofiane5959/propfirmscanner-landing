...
|---|---|---|---|---|
| `profit_split` | script / seed (77), SQL (52), lib (17), /compare (15), fiche firme (14), composant partage (10), autre (4), /best-for (2) | SQL (21), script / seed (3) | firm_program_plans.profit_split | **BLOQUE** |
| `max_profit_split` | SQL (21), /compare (20), autre (9), script / seed (9), fiche firme (7), composant partage (6), dashboard (4), /deals (4), lib (3), admin (2), /best-for (2) | SQL (6), admin (1) | firm_program_plans.profit_split (max) | **BLOQUE** |
| `min_price` | /compare (25), script / seed (21), fiche firme (20), composant partage (15), SQL (13), lib (11), autre (8), dashboard (4), /deals (4), /best-for (3), admin (2) | SQL (7), admin (1) | firm_program_plans.regular_price (min) | **BLOQUE** |
| `max_price` | script / seed (10), SQL (8), fiche firme (4), lib (2), autre (1) | SQL (6) | firm_program_plans.regular_price (max) | **BLOQUE** |
| `account_sizes` | script / seed (2), fiche firme (1), lib (1), autre (1) | — | firm_program_plans.account_size | **BLOQUE** |
| `drawdown_type` | script / seed (102), SQL (16), composant partage (6), lib (6), fiche firme (4), /compare (3) | SQL (17) | firm_program_plans.drawdown_type | **BLOQUE** |
| `consistency_rule` | script / seed (61), SQL (13), lib (12), fiche firme (3), composant partage (3), /compare (1), dashboard (1) | SQL (8) | firm_program_plans.consistency_rule | **BLOQUE** |
...
| `reset_fee` | script / seed (29), SQL (7), lib (3), fiche firme (2) | SQL (2) | firm_program_plans.reset_fee | **BLOQUE** |
...
| `commissions` | autre (8), script / seed (5), composant partage (3), fiche firme (2), dashboard (1) | SQL (5) | firm_rules (scope live) | **BLOQUE** |
...
| `leverage_forex` | SQL (5), fiche firme (3), script / seed (3) | SQL (2) | sans objet sur une firme futures | **BLOQUE** |
...
| `platforms_list` | /compare (3), fiche firme (3), script / seed (2), SQL (1) | SQL (2) | firm_platforms | **BLOQUE** |
...
| `cost_timeline` | script / seed (25), SQL (11), fiche firme (2) | SQL (6) | firm_program_plans (frais) | **BLOQUE** |
| `program_guide` | script / seed (37), SQL (5), fiche firme (3) | SQL (8) | firm_programs.summary | **BLOQUE** |
| `proof_stats` | SQL (5), script / seed (3), fiche firme (2) | — | editorial, a re-sourcer | **BLOQUE** |
| `value_strip` | script / seed (4), fiche firme (2), SQL (2) | SQL (2), script / seed (1) | derive par universalFact() | **BLOQUE** |
| `included_items` | script / seed (31), fiche firme (2) | SQL (8) | firm_platforms + firm_rules | **BLOQUE** |
| `discount_code` | SQL (27), script / seed (18), /deals (16), composant partage (8), fiche firme (7), /compare (5), lib (4), route API (2), autre (2), admin (1) | SQL (5), admin (1), script / seed (1) | firm_promotions.code | **BLOQUE** |
| `discount_percent` | /deals (20), SQL (19), script / seed (15), composant partage (13), /compare (12), lib (10), fiche firme (8), autre (6), admin (1) | SQL (6), script / seed (2), admin (1) | firm_promotions.discount_value | **BLOQUE** |
| `discount_note` | fiche firme (3), script / seed (3), lib (2) | — | firm_promotions.editorial_note | **BLOQUE** |
| `discount_expires_at` | SQL (12), fiche firme (6), script / seed (5), /deals (2), lib (2) | SQL (1) | firm_promotions.expires_at | **BLOQUE** |
| `platforms` | script / seed (37), lib (28), /compare (26), composant partage (23), SQL (21), fiche firme (20), autre (10), /best-for (1) | SQL (10) | firm_platforms | **BLOQUE** |
| `payout_methods` | script / seed (26), SQL (13), lib (3), fiche firme (2), autre (1) | SQL (9) | firm_payment_methods (flow=payout) | **BLOQUE** |
| `payout_frequency` | script / seed (35), fiche firme (5), /compare (3), SQL (3), lib (3), composant partage (2), autre (1) | SQL (9) | firm_program_plans.days_between_payouts | **BLOQUE** |
| `key_rules` | script / seed (35), SQL (8), lib (3), fiche firme (2) | SQL (8) | firm_rules (severite) | **BLOQUE** |
| `journey` | script / seed (38), SQL (14), fiche firme (9), composant partage (7), autre (6), lib (4), /best-for (1), dashboard (1) | SQL (8) | firm_program_plans.phase (derive) | **BLOQUE** |
| `founded` | fiche firme (17), lib (5), script / seed (5), composant partage (3), SQL (3) | — | prop_firms.founded (a unifier) | **BLOQUE** |
| `founded_year` | script / seed (5), fiche firme (3), lib (3), SQL (2), autre (1) | SQL (5) | prop_firms.founded (a unifier) | **BLOQUE** |
| `year_founded` | fiche firme (4), lib (3), script / seed (2), /compare (1), SQL (1) | — | prop_firms.founded (a unifier) | **BLOQUE** |
...
| `has_instant_funding` | /compare (10), autre (5), composant partage (5), SQL (3), admin (2), script / seed (2) | SQL (1) | firm_programs.kind | **BLOQUE** |
...
| `allows_scalping` | /compare (12), lib (9), script / seed (9), SQL (8), autre (6), composant partage (6), fiche firme (4), admin (2), /best-for (1) | SQL (5) | firm_rules (scope conduct) | **BLOQUE** |
| `allows_news_trading` | /compare (11), lib (9), script / seed (9), SQL (8), composant partage (6), autre (5), fiche firme (3), admin (2), /best-for (1) | SQL (5) | firm_rules (scope conduct) | **BLOQUE** |
...
| `allows_ea` | /compare (11), SQL (9), lib (8), script / seed (7), composant partage (6), autre (5), fiche firme (3), admin (2), /best-for (1) | SQL (6) | firm_rules (scope conduct) | **BLOQUE** |
...
| `discount_status` | SQL (8), script / seed (5) | SQL (1) | firm_promotions.status | LIBRE |
| `discount_starts_at` | SQL (6), script / seed (3), lib (2) | — | firm_promotions.starts_at | LIBRE |
