...
--                -> coller -> Run.
--
-- Ce que ca corrige, mesure sur tes pages en production le 3 septembre 2026 :
--
--   FTMO      founded_year   null      -> 2015
--             headquarters   null      -> Prague
--             min_price      89        -> 79 EUR, prix reel du 1-Step 10K
--             drawdown_type  "Static"  -> glissant (1-Step) / fixe (2-Step)
--             remise 19 % SANS code    -> retiree, elle etait inobtenable
--             platforms      null      -> MT4, MT5, cTrader
--             8 challenges melangeant les deux produits -> 9, separes
--
--   THE5ERS   trustpilot     4.8       -> 4.7
--             founded_year   null      -> 2016
--             headquarters   null      -> Londres, FIVE PERCENT ONLINE LTD
--             platforms      null      -> MT5, cTrader
--             3 challenges non sources -> 1, le seul officiellement source
--
-- Source : dossier_ftmo_the5ers.md, releve du 3 septembre 2026. Le dossier
-- hierarchise ses sources et cette migration suit cette hierarchie : seul ce
-- qui vient des pages officielles est ecrit. Ce qui vient de PropFirmMatch ou
-- de TheTrustedProp reste en commentaire, en fin de fichier, avec la raison.
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- Elles concernent toute la table prop_firms, pas seulement ces deux firmes.
...
-- -----------------------------------------------------------------------------
-- 3. FTMO — identite et statut  (source : ftmo.com)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. FTMO — les deux produits  (source : ftmo.com/fr/trading-objectives/)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 5. THE5ERS — identite et statut  (source : mentions legales)
-- -----------------------------------------------------------------------------
update prop_firms set
  founded_year       = 2016,
...
-- -----------------------------------------------------------------------------
-- 6. THE5ERS — un seul programme est source officiellement
-- -----------------------------------------------------------------------------
