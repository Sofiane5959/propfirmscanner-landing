...
--
-- Source : classeur du 2026-09-07, releve sur le configurateur et la FAQ officiels.
...
insert into firm_programs (firm_slug, slug, name, kind, evaluation_steps, summary, sort_order, max_funded_accounts, max_funded_note, source_url, verified_at) values
  ('futureselite', 'elite', 'Elite', 'evaluation', 1, 'One-step evaluation, end-of-day drawdown and no daily loss limit. The only programme whose payout amount rule is documented in detail.', 1, 5, 'Counts towards the shared cap of 5 funded accounts across Elite, Custom, Instant and Nitro.', 'https://futureselite.com/#pricing', timestamptz '2026-09-07'),
  ...
  ('futureselite', 'prime', 'Prime', 'evaluation', 1, 'The only programme with a daily loss limit in both phases. It also carries the longest bundle ladder, up to ten accounts.', 3, 10, 'Prime has its own cap: 10 active funded accounts.', 'https://futureselite.com/#pricing', timestamptz '2026-09-07'),
...
insert into firm_promotions (firm_slug, program_slug, account_size, code, label,
  ...
  ('futureselite', 'elite', 25000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.25, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'elite', 50000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'elite', 100000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'elite', 150000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'nitro', 25000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'nitro', 50000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'nitro', 100000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'nitro', 150000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'prime', 25000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'prime', 50000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.35, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'prime', 100000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.35, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'prime', 150000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.35, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'instant', 50000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'instant', 100000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', 'instant', 150000, 'SUMMER', 'Current public offer — expiry not published', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', true, 'Automatically applied by the configurator on 2026-09-04. Volatile: reverify before publication.'),
  ('futureselite', null, null, 'SCANNED', '30% with code SCANNED — eligibility and best-price status pending confirmation', 'percent', 0.3, null, null, timestamptz '2026-09-07', 'https://futureselite.com/#pricing', 'active', false, 'Verified at 30% on 2026-09-07. Beats the public SUMMER offer on Elite 25K (25%), matches it on eleven plans (30%), and is below it on Prime 50K/100K/150K (35%). Never label it best deal, best verified price, applicable to all programs, or without expiry: per-program eligibility and expiry are both unconfirmed.');
...
insert into firm_rules (firm_slug, scope, title, detail, severity, confidence, source_url, verified_at, sort_order) values
  ...
  ('futureselite', 'limits', 'Active funded accounts', 'Maximum 10 funded accounts overall; maximum 10 Prime; maximum 3 Nitro; maximum 5 combined across Elite, Custom, Instant and Nitro.', 'restriction', 'verified', 'https://faq.futureselite.com/en/articles/11949051-how-many-accounts-can-i-have-with-futureselite', timestamptz '2026-09-07', 15),
