...
export const homeMetadata: Metadata = {
  title: 'PropFirm Scanner - Compare 55+ Prop Trading Firms Instantly | Best Prop Firms 2025',
  ...
  keywords: 'prop firm, prop trading, funded trader, FTMO, FundedNext, Goat Funded Trader, trading challenge, forex prop firm, best prop firm 2025, prop firm comparison, funded account, trading capital',
  openGraph: {
...
export const compareMetadata: Metadata = {
  title: 'Compare Prop Firms 2025 - Side by Side Comparison | PropFirm Scanner',
  ...
  openGraph: {
    title: 'Compare Prop Firms 2025 - Side by Side Comparison',
...
export const dealsMetadata: Metadata = {
  title: 'Prop Firm Discount Codes & Deals 2025 - Up to 80% OFF | PropFirm Scanner',
  ...
  openGraph: {
    title: 'Prop Firm Discount Codes & Deals 2025 - Up to 80% OFF',
...
export const compareJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'ItemList',
  name: 'Best Prop Trading Firms 2025',
...
export const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'What is the best prop firm in 2025?',
      acceptedAnswer: {
        '@type': 'Answer',
