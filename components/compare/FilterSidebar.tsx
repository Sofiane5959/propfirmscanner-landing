...
export function FilterSidebar({ onFilterChange, filters }: FilterSidebarProps) {
  ...
  return (
    <div className="bg-dark-700/50 rounded-xl p-6 border border-border sticky top-24">
      ...
      <div className="mb-6">
        ...
        <select
          ...
          className="w-full bg-dark-600 text-white rounded-lg px-4 py-2 border border-border-hover focus:border-accent focus:outline-none"
        >
        ...
        <div className="space-y-2">
          {['1-step', '2-step', '3-step', 'instant'].map((type) => (
            <label key={type} className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                className="w-4 h-4 text-accent bg-dark-600 border-border-hover focus:ring-accent"
              />
              <span className="text-text-secondary group-hover:text-white capitalize">
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            <input
              ...
              className="w-4 h-4 text-accent bg-dark-600 border-border-hover focus:ring-accent"
            />
            <span className="text-text-secondary group-hover:text-white">Any type</span>
          </label>
        </div>
      </div>
          ...
          {[
            ...
            <label key={style.value} className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                className="w-4 h-4 text-accent bg-dark-600 border-border-hover focus:ring-accent"
              />
              <span className="text-text-secondary group-hover:text-white">{style.label}</span>
            </label>
          ))}
          <label className="flex items-center gap-3 cursor-pointer group">
            <input
              ...
              className="w-4 h-4 text-accent bg-dark-600 border-border-hover focus:ring-accent"
            />
            <span className="text-text-secondary group-hover:text-white">Any style</span>
          </label>
        </div>
      </div>
