...
import { X, Shield, Zap, Loader2 } from 'lucide-react';
...
interface AuthGuardModalProps {
  isOpen: boolean;
  onClose: () => void;
  action?: string; // e.g., "ajouter un compte", "simuler un trade"
}
...
export function AuthGuardModal({ isOpen, onClose, action }: AuthGuardModalProps) {
  ...
  const actionText = action || 'continuer';
