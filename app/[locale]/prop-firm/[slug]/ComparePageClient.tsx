...
const countryToCode: Record<string, string> = {
  ...
  'Czech Republic': 'cz', 'Czechia': 'cz', 'UAE': 'ae', 'United Arab Emirates': 'ae',
  'Dubai': 'ae', 'Australia': 'au', 'Canada': 'ca', 'Germany': 'de', 'France': 'fr',
  'Spain': 'es', 'Italy': 'it', 'Netherlands': 'nl', 'Switzerland': 'ch',
  'Singapore': 'sg', 'Hong Kong': 'hk', 'Japan': 'jp', 'South Africa': 'za',
  'Nigeria': 'ng', 'India': 'in', 'Pakistan': 'pk', 'Malaysia': 'my',
  'Indonesia': 'id', 'Thailand': 'th', 'Vietnam': 'vn', 'Philippines': 'ph',
  'Poland': 'pl', 'Hungary': 'hu', 'Romania': 'ro', 'Bulgaria': 'bg',
  'Cyprus': 'cy', 'Malta': 'mt', 'Estonia': 'ee', 'Latvia': 'lv', 'Lithuania': 'lt',
  'Israel': 'il', 'Turkey': 'tr', 'Mexico': 'mx', 'Brazil': 'br', 'Argentina': 'ar',
  'Colombia': 'co', 'Chile': 'cl', 'Peru': 'pe', 'St. Vincent': 'vc',
  'Saint Vincent': 'vc', 'Seychelles': 'sc', 'Bahamas': 'bs', 'Belize': 'bz',
  'Panama': 'pa', 'Costa Rica': 'cr', 'New Zealand': 'nz', 'Ireland': 'ie',
  'Belgium': 'be', 'Austria': 'at', 'Sweden': 'se', 'Norway': 'no', 'Denmark': 'dk',
  'Finland': 'fi', 'Portugal': 'pt', 'Greece': 'gr', 'China': 'cn', 'Korea': 'kr',
  'South Korea': 'kr', 'Taiwan': 'tw',
}

// Platform logos - stored in public/platforms/
...
// Platform Logo Component with real images
const PlatformLogo = ({ platform }: { platform: string }) => {
  const logoPath = platformLogos[platform]
  
  if (logoPath) {
    return (
      <div className="w-9 h-9 rounded-lg bg-white flex items-center justify-center overflow-hidden p-1" title={platform}>
        <img 
          src={logoPath} 
          alt={platform}
  ...
  // Default fallback
  return (
    <div className="w-9 h-9 rounded-lg bg-gray-600 flex items-center justify-center" title={platform}>
