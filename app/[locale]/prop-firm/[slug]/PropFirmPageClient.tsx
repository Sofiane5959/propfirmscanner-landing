...
const COPY = {
  ...
  de: {
    ...
    seeRules: 'Die wichtigsten Regeln ansehen',
    ...
    billedMonthly: 'Monatliche Abrechnung, nur während der Evaluierung.',
    commission: '',
    founded: 'Gegründet',
    country: 'Land',
    regulated: 'Reguliert',
    ...
    includedValue: 'Enthaltene Leistungen',
    beforeBuy: 'Vor dem Kauf wissen',
    scaling: 'Skalierung',
    honest: 'Ehrliche Einschätzung',
    whyChoose: (f: string) => `${f}: Stärken und Punkte zum Abwägen`,
    honestIntro:
      'Unsere unabhängige Analyse auf Basis geprüfter offizieller Regeln und Unterlagen.',
    strengths: 'Stärken',
    limitations: 'Gut zu wissen',
    restrictedCountries: (n: number) => `Die ${n} nicht akzeptierten Länder und Gebiete ansehen`,
    ...
    risk:
      'Der Handel birgt ein erhebliches Verlustrisiko. Setzen Sie nur Kapital ein, dessen Verlust Sie sich leisten können. Prop-Firm-Evaluierungen sind simulierte Handelsumgebungen — lesen Sie vor dem Kauf alle Regeln sorgfältig.',
    freeWith: 'In jedem Abo enthalten',
    freeWithSub: 'Kein separater Kauf, kein Upselling.',
  },
  es: {
    chooseProgram: 'Elegir mi programa',
    seeRules: 'Ver las reglas clave',
    ...
    billedMonthly: 'Cobro mensual solo durante la evaluación.',
    commission: '',
    founded: 'Fundada en',
    country: 'País',
    regulated: 'Regulada',
    ...
    includedValue: 'Valor incluido',
    beforeBuy: 'Antes de comprar',
    scaling: 'Escalado',
    honest: 'Opinión honesta',
    whyChoose: (f: string) => `${f}: puntos fuertes y aspectos a tener en cuenta`,
    honestIntro:
      'Nuestro análisis independiente, basado en reglas y documentos oficiales verificados.',
    strengths: 'Puntos fuertes',
    limitations: 'Aspectos a tener en cuenta',
    restrictedCountries: (n: number) => `Ver los ${n} países y territorios no aceptados`,
    ...
    risk:
      'Operar conlleva un riesgo sustancial de pérdida. Utiliza únicamente capital que puedas permitirte perder. Las evaluaciones de prop firms son entornos de trading simulados: lee atentamente todas las reglas antes de comprar.',
    freeWith: 'Incluido en cada suscripción',
    freeWithSub: 'Sin compra aparte, sin extras de pago.',
  },
  pt: {
    chooseProgram: 'Escolher o meu programa',
    seeRules: 'Ver as regras essenciais',
    ...
    billedMonthly: 'Cobrança mensal apenas durante a avaliação.',
    commission: '',
    founded: 'Fundada em',
    country: 'País',
    regulated: 'Regulada',
    ...
    includedValue: 'Valor incluído',
    beforeBuy: 'Antes de comprar',
    scaling: 'Escalonamento',
    honest: 'Opinião honesta',
    whyChoose: (f: string) => `${f}: pontos fortes e pontos a conhecer`,
    honestIntro:
      'A nossa análise independente, a partir de regras e documentos oficiais verificados.',
    strengths: 'Pontos fortes',
    limitations: 'Pontos a conhecer',
    restrictedCountries: (n: number) => `Ver os ${n} países e territórios não aceites`,
    ...
    risk:
      'Negociar envolve um risco substancial de perda. Utilize apenas capital que possa perder. As avaliações de prop firms são ambientes de negociação simulados — leia atentamente todas as regras antes de comprar.',
    freeWith: 'Incluído em cada subscrição',
    freeWithSub: 'Sem compra separada, sem extras pagos.',
  },
  ar: {
    chooseProgram: 'اختر برنامجك',
    seeRules: 'اطّلع على القواعد الأساسية',
    ...
    billedMonthly: 'فوترة شهرية أثناء فترة التقييم فقط.',
    commission: '',
    founded: 'سنة التأسيس',
    country: 'الدولة',
    ...
    includedValue: 'ما يشمله الاشتراك',
    beforeBuy: 'قبل الشراء',
    scaling: 'زيادة رأس المال',
    honest: 'رأي صريح',
    whyChoose: (f: string) => `${f}: نقاط القوة وأمور ينبغي معرفتها`,
    honestIntro: 'تحليلنا المستقل، استنادًا إلى قواعد ومستندات رسمية تم التحقق منها.',
    strengths: 'نقاط القوة',
    limitations: 'أمور ينبغي معرفتها',
    restrictedCountries: (n: number) => `عرض الدول والأقاليم غير المقبولة (${n})`,
    ...
    risk:
      'ينطوي التداول على مخاطر خسارة كبيرة. لا تتداول إلا برأس مال يمكنك تحمّل خسارته. تقييمات شركات التداول الاحترافية هي بيئات تداول محاكاة — اقرأ جميع القواعد بعناية قبل الشراء.',
    freeWith: 'مجانًا مع كل اشتراك',
    freeWithSub: 'دون شراء منفصل ودون عروض إضافية.',
  },
  hi: {
    chooseProgram: 'अपना प्रोग्राम चुनें',
    seeRules: 'मुख्य नियम देखें',
    ...
    billedMonthly: 'केवल मूल्यांकन के दौरान मासिक शुल्क।',
    commission: '',
    founded: 'स्थापना',
    country: 'देश',
    regulated: 'विनियमित',
    ...
    includedValue: 'शामिल मूल्य',
    beforeBuy: 'खरीदने से पहले',
    scaling: 'स्केलिंग',
    honest: 'निष्पक्ष राय',
    whyChoose: (f: string) => `${f}: खूबियाँ और जानने योग्य बातें`,
    honestIntro: 'सत्यापित आधिकारिक नियमों और दस्तावेज़ों पर आधारित हमारा स्वतंत्र विश्लेषण।',
    strengths: 'खूबियाँ',
    limitations: 'जानने योग्य बातें',
    restrictedCountries: (n: number) => `स्वीकार न किए जाने वाले ${n} देश और क्षेत्र देखें`,
    ...
    risk:
      'ट्रेडिंग में पर्याप्त जोखिम होता है। केवल उतनी पूँजी लगाएँ जितनी आप खो सकते हैं। प्रॉप फ़र्म मूल्यांकन सिम्युलेटेड ट्रेडिंग वातावरण हैं — खरीदने से पहले सभी नियम ध्यान से पढ़ें।',
    freeWith: 'हर सब्सक्रिप्शन के साथ मुफ़्त',
    freeWithSub: 'कोई अलग खरीद नहीं, कोई अतिरिक्त शुल्क नहीं।',
  },
}
