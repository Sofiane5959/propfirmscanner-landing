      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">{t.s1p1}</p>
            <p className="text-text-secondary">{t.s1p2}</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">{t.s2p2}</p>
            <h3 className="text-xl font-medium text-white mb-3">{t.s2h2}</h3>
            <p className="text-text-secondary mb-4">{t.s2p3}</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">{t.s4p2}</p>
            <ul className="list-disc list-inside text-text-secondary space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mt-4">{t.s8p2}</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">{t.s9Title}</h2>
            <p className="text-text-secondary">{t.s9p1}</p>
          </section>
